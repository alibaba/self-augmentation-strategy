...
from .tokenization_sas import SasTokenizer
...
class SasTokenizerFast(BertTokenizerFast):
    r"""
    Construct a "fast" electra tokenizer (backed by HuggingFace's `tokenizers` library).

    :class:`~transformers.SasTokenizerFast` is identical to :class:`~transformers.BertTokenizerFast` and runs
    ...
    slow_tokenizer_class = SasTokenizer
