...
# SAS_PRETRAINED_CONFIG_ARCHIVE_MAP = {
#     "google/sas-small-generator": "https://huggingface.co/google/sas-small-generator/resolve/main/config.json",
#     "google/sas-base-generator": "https://huggingface.co/google/sas-base-generator/resolve/main/config.json",
#     "google/sas-large-generator": "https://huggingface.co/google/sas-large-generator/resolve/main/config.json",
#     "google/sas-small-discriminator": "https://huggingface.co/google/sas-small-discriminator/resolve/main/config.json",
#     "google/sas-base-discriminator": "https://huggingface.co/google/sas-base-discriminator/resolve/main/config.json",
#     "google/sas-large-discriminator": "https://huggingface.co/google/sas-large-discriminator/resolve/main/config.json",
# }


class SasConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers.SasModel` or a
    :class:`~transformers.TFSasModel`. It is used to instantiate a SAS model according to the specified
    arguments, defining the model architecture. Instantiating a configuration with the defaults will yield a similar
    configuration to that of the SAS `google/sas-small-discriminator
    <https://huggingface.co/google/sas-small-discriminator>`__ architecture.
    ...
    Args:
        vocab_size (:obj:`int`, `onal`, defaults to 30522)
            Vocabulary size of the SAS model. Defines the number of different tokens that can be represented by the
            :obj:`inputs_ids` passed when calling :class:`~transformers.SasModel` or
            :class:`~transformers.TFSasModel`.
        ...
        type_vocab_size (:obj:`int`, `onal`, defaults to 2)
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers.SasModel` or
            :class:`~transformers.TFSasModel`.
    ...
    Examples::
        ...
        >>> from transformers import SasModel, SasConfig

        >>> # Initializing a SAS sas-base-uncased style configuration
        >>> configuration = SasConfig()

        >>> # Initializing a model from the sas-base-uncased style configuration
        >>> model = SasModel(configuration)
